...
class AddSubcategoryPlannung extends StatelessWidget {
  const AddSubcategoryPlannung({super.key});
          ...
          children: [
            ...
            TextFormField(
              ...
              onFieldSubmitted: (value) {
                createSubCategoryPlannung(value);
            ...
            customButton(
              ...
              onPressed: () {
                createSubCategoryPlannung(newSubCategoryName);
